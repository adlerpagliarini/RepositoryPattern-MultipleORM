...
{
    public class TaskToDoEntityFrameworkController : Controller
    {
        private readonly ITaskToDoEntityFrameworkService taskToDoService;

        public TaskToDoEntityFrameworkController(ITaskToDoEntityFrameworkService taskToDoService)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                return RedirectToAction("Index",
                      new RouteValueDictionary(
                          new { controller = "EntityFramework", action = "Index", Id = taskToDo.UserId }));
            }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id, int userId)
        {
            ...
            return RedirectToAction("Index",
                      new RouteValueDictionary(
                          new { controller = "EntityFramework", action = "Index", Id = userId }));
        }
